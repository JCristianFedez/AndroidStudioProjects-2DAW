...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tvInteresesMain;
    private TextView tvNombreMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvInteresesMain=(TextView)findViewById(R.id.tvInteresesMain);
        tvNombreMain=(TextView)findViewById(R.id.tvNombreMain);
        ...
        if(extras==null){
            ...
            tvNombreMain.setText("Nombre: "+user.getNombre()+", "+user.getApellidos());
            tvInteresesMain.setText("Intereses: "+user.getIntereses());
